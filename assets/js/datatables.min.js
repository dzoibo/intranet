...
(function (k) {
    ...
    function Ab(a) {
        if (!u.__browser) {
            ...
            u.__browser = b;
            var c = k("<div/>")
                    .css({ position: "relative", top: 0, left: -1 * k(y).scrollLeft(), height: 1, width: 1, overflow: "hidden" })
                    .append(
                        k("<div/>")
                            .css({ position: "relative", top: 1, left: 1, width: 100, overflow: "scroll" })
    ...
    function wa(a, b) {
        ...
        for (e = b.length; f < e; f++) {
            ...
            for (c = g.firstChild; c; ) {
                if ("TD" == c.nodeName.toUpperCase() || "TD" == c.nodeName.toUpperCase()) {
    ...
    function Jb(a) {
        var b = a.oClasses,
            ...
            e = a.oPreviousSearch,
            f = a.aanFeatures,
            g = '<input type="search" class="i_search"' + b.sFilterInput + '"/>',
            h = d.sSearch;
